...
import StatCard from '@/components/store-admin/StatCard';
import LatestOrders from '@/components/store-admin/LatestOrders';
import { fetchSalesData, fetchRevenueData, API_ENDPOINTS } from '@/services/store-admin/fakeApi';
