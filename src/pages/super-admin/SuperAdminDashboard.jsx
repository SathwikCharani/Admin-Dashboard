        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className={`p-6 rounded-2xl border transition-all duration-300 ${isDark ? 'bg-[#2c3136] border-slate-700 shadow-xl' : 'bg-white border-slate-200 shadow-sm'}`}>
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={() => navigate('/hub-list')} className="text-xs font-bold text-brand hover:underline">View All</button>
            </div>
          ...
          <div className={`p-6 rounded-2xl border transition-all duration-300 ${isDark ? 'bg-[#2c3136] border-slate-700 shadow-xl' : 'bg-white border-slate-200 shadow-sm'}`}>
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={() => navigate('/store-list')} className="text-xs font-bold text-orange-500 hover:underline">View All</button>
            </div>
            <div className="overflow-x-auto min-h-[150px]">
              <table className="w-full text-left">
                <thead>
